<%@ Page Language="C#" Title="Cadastro" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="DataPlus.Registration.Insert" %>
<%@ Register TagPrefix="DC" Namespace="DataPlus.Custom.Controls" %>
                ...
                <div class="card-body">
                        ...
                        <div class="col-4 col-md-2">
                            <div class="form-group">
                                ...
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                                        <asp:Button CssClass="btn btn-primary btn-block mt-1 font-weight-bold" runat="server"  ID="btn_adicionar_telefone" Text="+ Adicionar" UseSubmitBehavior="False" ValidateRequestMode="Disabled" ViewStateMode="Disabled" OnClientClick="AdicionarTelefone()" />
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <asp:GridView runat="server" ID="Telefones"  CssClass="table table-hover">
